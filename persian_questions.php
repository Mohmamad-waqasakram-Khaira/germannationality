        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Persian Questions</li>
                    <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
               ...
               <table id="kt_datatable_zero_configuration" class="table table-row-bordered gy-5">
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        ...
                        <tr>
                            ...
                            <!--begin::Action=-->
                            <td class="text-end">
                                <a href="javascript:void(0);" onClick="question_details_persian('<?php echo $row['id']; ?>')" class="badge badge-light-success px-3 mb-2"><i class="fas fa-eye text-success" ></i>&nbsp;&nbsp;View Details</a>
                                <!--end::Svg Icon--></a>
                                <!--begin::Menu-->
                               <a href="edit_question_persian.php?id=<?php echo $row['id']; ?>"  class="badge badge-light-warning px-3"><i class="fas fa-pencil text-warning" ></i>&nbsp;&nbsp;Edit</a>
                                    <!--begin::Menu item-->
...
<!--end::Content wrapper-->
<div class="modal fade" tabindex="-1" id="detailsModal_persian">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body" id="detailsModal_body_persian">
