	...
	<!--begin::Category-->
		<div class="card card-flush">
			...
			<div class="card-body pt-0">
				<!--begin::Table-->
					<form id="update_question_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#" enctype="multipart">
						<!--begin::Modal body-->
						<div class="mb-5 fv-row" style="display: none;">
						...
						<fieldset class="setting-fieldset">
							<legend class="">Question Section</legend>
									...
									$rowquestion = mysqli_fetch_array($getq);
									 ?>
									<input type="text" class="form-control form-control-solid text-capitalize" placeholder="Enter Question (<?php echo $rec_lang['language_english'];?>)" value="<?php echo htmlentities($rowquestion['q_'.$rec_lang['language_english']]) ?>" name="q_<?php echo $rec_lang['language_english'];?>">
									<!--end::Input-->
						...
						<fieldset class="setting-fieldset">
							<legend class="">Answer Section</legend>
									<div class="row">
										...
										'ansid' => $rowans['id'],
										'a' => $rowans['a_'.$rec_lang['language_english']],
								...
								?>	
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input type="text" class="form-control form-control-solid text-capitalize" placeholder="Enter Answer1 (<?php echo $rec_lang['language_english'];?>)" value="<?php echo
									 $productResult[0]['a'] ?>" name="a1_<?php echo $rec_lang['language_english'];?>">
								...
								<!--begin::Input group-->
									...
									<input type="text" class="form-control form-control-solid text-capitalize" placeholder="Enter Answer2 (<?php echo $rec_lang['language_english'];?>)"value="<?php echo
									 $productResult[1]['a'] ?>" name="a2_<?php echo $rec_lang['language_english'];?>">
									...
									<input type="text" class="form-control form-control-solid text-capitalize" placeholder="Enter Answer3 (<?php echo $rec_lang['language_english'];?>)"value="<?php echo
									 $productResult[2]['a'] ?>" name="a3_<?php echo $rec_lang['language_english'];?>">
									...
									<input type="text" class="form-control form-control-solid text-capitalize" placeholder="Enter Answer4 (<?php echo $rec_lang['language_english'];?>)"value="<?php echo
									 $productResult[3]['a'] ?>" name="a4_<?php echo $rec_lang['language_english'];?>">
									 ...
									 $productResult[3]['ansid'] ?>" hidden>
										...
										<div class="col-lg-8 fv-row">
										<input type="text" class="form-control form-control-solid" placeholder="Enter Answer3 value" name="a4_value" value="<?php echo
		...
		<div class="col-lg-6 fv-row">
			...
			<input type="file" class="form-control form-control-solid mb-3" name="audio_<?php echo $rec_lang['language_english'];?>" accept="audio/*" >
			<audio controls autoplay muted> 
			  <source src="<?php echo 'uploads/'.$rec_lang['language_english'].'_audio/'.$rowquestion['audio_'.$rec_lang['language_english']] ?>" type="audio/mp3">
			</audio>
									<!--end::Input-->
								</div>
	</div>
...
<button type="submit" id="kt_question_update" value="register" class="btn btn-primary">
...
<script type="text/javascript" src="questions/update_question_lang_wise.js"></script>