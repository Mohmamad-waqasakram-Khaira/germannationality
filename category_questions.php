               ...
               <table id="kt_datatable_zero_configuration" class="table table-row-bordered gy-5">
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        <!--begin::Table row-->
                         ...
                         $category_query = '';
if($category_id=='26'){
    $category_query = 'SELECT * FROM `questions` WHERE question_image!=""';
}
elseif ($category_id=='27') {
    $category_query = 'SELECT * FROM `questions` WHERE answervideo!=""';
}
elseif ($category_id=='28') {
    $category_query = 'SELECT * FROM `questions`';
}
else{
    $category_query='Select * from question_category join questions on questions.id= question_category.question_id where category_id='.$category_id;
}

                         $query=mysqli_query($con,"$category_query");
                                $cnt=1;
