...
$quergetaud=mysqli_query($con, "Select audio_arabic from audiofiles where qid='$qid'");
...
<?php while($row = mysqli_fetch_array($querget)){ ?>
	<tr class="fw-semibold text-gray-600">
	<th>Questions: </th>
	<td>German: <?php echo htmlentities($row['q_german'])?><br><br>Arabic:   <?php echo htmlentities($row['q_arabic'])?></td>
	</tr>
	<tr>
	<th>Video File: </th>
	<td><?php
...
?>
	<tr class="fw-semibold text-gray-600">
	<th>Audio File (Urdu): </th>

	<td>
		<audio controls autoplay muted>
		  <source src="uploads/arabic_audio/<?php echo htmlentities($rowaudio['audio_arabic']) ?>" type="audio/mp3">
		</audio>
...
<?php while ($answerrow=mysqli_fetch_array($qanswerget)){
	...
	<tr class="fw-semibold text-gray-600">
	<th>Answer:</th>	
	<td>German: <?php echo $answerrow['a_german']; ?><br><br>Arabic:  <?php echo $answerrow['a_arabic']; ?></td>
