...
$quergetaud=mysqli_query($con, "Select audio_bengali from audiofiles where qid='$qid'");
...
<?php while($row = mysqli_fetch_array($querget)){ ?>
	<tr class="fw-semibold text-gray-600">
	<th>Questions: </th>
	<td>German: <?php echo htmlentities($row['q_german'])?><br><br>Bengali:   <?php echo htmlentities($row['q_bengali'])?></td>
	</tr>
	<tr>
	<th>Video File: </th>
	<td><?php
...
?>
	<tr class="fw-semibold text-gray-600">
	<th>Audio File (Bengali): </th>

	<td>
		<audio controls autoplay muted>
		  <source src="uploads/bengali_audio/<?php echo htmlentities($rowaudio['audio_bengali']) ?>" type="audio/mp3">
		</audio>
...
<?php while ($answerrow=mysqli_fetch_array($qanswerget)){
	...
	<tr class="fw-semibold text-gray-600">
	<th>Answer:</th>	
	<td>German: <?php echo $answerrow['a_german']; ?><br><br>Bengali:  <?php echo $answerrow['a_bengali']; ?></td>
