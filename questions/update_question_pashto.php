...
include("../includes/config.php");
 ...
 $q_pashto=$_POST['q_pashto'];
 
 $a1_german=$_POST['a1_german'];
 $a1_pashto=$_POST['a1_pashto'];
 $a2_german=$_POST['a2_german'];
 $a2_pashto=$_POST['a2_pashto'];
 $a3_german=$_POST['a3_german'];
 $a3_pashto=$_POST['a3_pashto'];
 $ans1id=$_POST['ans1id'];
 $ans2id=$_POST['ans2id'];
 $ans3id=$_POST['ans3id'];
...
if($answervideo=='' || $question_image==''){
	$querya=mysqli_query($con, "UPDATE questions set q_german='$q_german', q_pashto= '$q_pashto' where id=$quesid");
}
if($answervideo!=''){
	$queryb=mysqli_query($con, "UPDATE questions set q_german='$q_german',answervideo ='$answervideo' where id=$quesid");
}
if($audiofile!=''){
    move_uploaded_file($_FILES['audiofile']['tmp_name'],"../uploads/pashto_audio/".$audiofile);
    $queryb=mysqli_query($con, "UPDATE audiofiles set audio_pashto='$audiofile' where qid=$quesid");
}
if($question_image!=''){
	$queryc=mysqli_query($con, "UPDATE questions set q_german='$q_german',question_image ='$question_image' where id=$quesid");
}
$query1=mysqli_query($con, "UPDATE answers set a_german ='$a1_german',a_pashto = '$a1_pashto',answer='$answer1',answer_value='$a1_value'   where id=$ans1id");
$query2=mysqli_query($con, "UPDATE answers set a_german ='$a2_german',a_pashto = '$a2_pashto',answer='$answer2',answer_value='$a2_value'   where id=$ans2id");
$query3=mysqli_query($con, "UPDATE answers set a_german ='$a3_german',a_pashto = '$a3_pashto',answer='$answer3',answer_value='$a3_value'   where id=$ans3id");
