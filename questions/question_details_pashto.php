...
$quergetaud=mysqli_query($con, "Select audio_pashto from audiofiles where qid='$qid'");
...
<?php while($row = mysqli_fetch_array($querget)){ ?>
	<tr class="fw-semibold text-gray-600">
	<th>Questions: </th>
	<td>German: <?php echo htmlentities($row['q_german'])?><br><br>Pashto:   <?php echo htmlentities($row['q_pashto'])?></td>
	</tr>
	<tr>
	<th>Video File: </th>
	<td><?php
...
?>
	<tr class="fw-semibold text-gray-600">
	<th>Audio File (Pashto): </th>

	<td>
		<audio controls autoplay muted>
		  <source src="uploads/pashto_audio/<?php echo htmlentities($rowaudio['audio_pashto']) ?>" type="audio/mp3">
		</audio>
...
<?php while ($answerrow=mysqli_fetch_array($qanswerget)){
	...
	<tr class="fw-semibold text-gray-600">
	<th>Answer:</th>	
	<td>German: <?php echo $answerrow['a_german']; ?><br><br>Pashto:  <?php echo $answerrow['a_pashto']; ?></td>
