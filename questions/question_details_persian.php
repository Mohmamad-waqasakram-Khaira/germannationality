...
$quergetaud=mysqli_query($con, "Select audio_persian from audiofiles where qid='$qid'");
...
<?php while($row = mysqli_fetch_array($querget)){ ?>
	<tr class="fw-semibold text-gray-600">
	<th>Questions: </th>
	<td>German: <?php echo htmlentities($row['q_german'])?><br><br>Persian:   <?php echo htmlentities($row['q_persian'])?></td>
	</tr>
	<tr>
	<th>Video File: </th>
	<td><?php
...
?>
	<tr class="fw-semibold text-gray-600">
	<th>Audio File (Persian): </th>

	<td>
		<audio controls autoplay muted>
		  <source src="uploads/persian_audio/<?php echo htmlentities($rowaudio['audio_persian']) ?>" type="audio/mp3">
		</audio>
...
<?php while ($answerrow=mysqli_fetch_array($qanswerget)){
	...
	<tr class="fw-semibold text-gray-600">
	<th>Answer:</th>	
	<td>German: <?php echo $answerrow['a_german']; ?><br><br>Persian:  <?php echo $answerrow['a_persian']; ?></td>
