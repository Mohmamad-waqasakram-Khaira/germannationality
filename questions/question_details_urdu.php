...
<?php while($row = mysqli_fetch_array($querget)){ ?>
	<tr class="fw-semibold text-gray-600">
	<th>Questions: </th>
	<td>German: <?php echo htmlentities($row['q_german'])?><br><br>Urdu:  <?php echo htmlentities($row['q_urdu'])?></td>
	</tr>
	<tr>
	<th>Video File: </th>
	<td><?php
...
<?php while ($answerrow=mysqli_fetch_array($qanswerget)){
	...
	<tr class="fw-semibold text-gray-600">
	<th>Answer:</th>	
	<td>German: <?php echo $answerrow['a_german']; ?><br><br>Urdu:  <?php echo $answerrow['a_urdu']; ?></td>
