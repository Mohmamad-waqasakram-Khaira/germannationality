// Define form element
const questionform = document.getElementById('update_question_form');
...
const buttonsquestion = document.getElementById('kt_question_update');
    ...
    if (validator) {
        validator.validate().then(function (status) {
            ...
            if (status == 'Valid') {
                ...
                var form_data = new FormData(document.getElementById("update_question_form"));
                     $.ajax({
                     type:"post",
                     data:form_data,  
                     url: "questions/update_question_lang_wise.php",
                     processData:false,
                     contentType:false,
                     cache:false,
                     async:false,
