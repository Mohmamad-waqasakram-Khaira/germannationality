	...
	<!--begin::Category-->
		<div class="card card-flush">
			...
			<div class="card-body pt-0">
				<!--begin::Table-->
					<form id="edit_question_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#" enctype="multipart/form-data">
						<!--begin::Modal body-->
						<div class="mb-5 fv-row">
							<?php $queryshowcat= mysqli_query($con,"select * from question_category join category on category.id=question_category.category_id where question_id='$ques_id' and category.id='$catid'");
                                
                             ?>
                             <input type="text" name="quesid" value="<?php echo $ques_id; ?>" hidden>
                             <input type="text" name="language" value="<?php echo $language; ?>" hidden>
                             <input type="text" name="catid" value="<?php echo $catid; ?>" hidden>

							<label class="required fs-5 fw-semibold mb-2">Category</label>
							
							<?php $rowcat= mysqli_fetch_array($queryshowcat); ?>
							<input class="form-control form-control-solid" type="text" value="<?php echo (htmlentities($rowcat['c_name_german']))?>" readonly>
						...
						<fieldset class="setting-fieldset">
							<legend class="">Question Section</legend>
									<div class="row">
									<?php $getq= mysqli_query($con, "select * from questions left join audiofiles on audiofiles.qid= questions.id where questions.id='$ques_id' ");
								...
								<!--begin::Input group-->
										...
										<div class="col-lg-6">
											<div class="mb-5 fv-row fv-plugins-icon-container">
									<!--begin::Label-->
									<label class=" fs-5 fw-semibold mb-2">Question (<?php echo $language ?>)</label>
									<!--end::Label-->
									<!--begin::Input-->
									<input type="text" class="form-control form-control-solid" placeholder="Enter Question" name="question" value="<?php echo htmlentities($rowquestion['q_'.$language]) ?>">
									<!--end::Input-->
								</div>
										</div>
						...
						<fieldset class="setting-fieldset">
							<legend class="">Answer Section</legend>
									...
									<?php $getans= mysqli_query($con, "select * from answers where answers.qid='$ques_id' ");
										...
										//var_dump($productResult[1]['ansgerman']); 
								...
								<!--begin::Input group-->
										...
										<div class="col-lg-6">
											<div class="mb-5 fv-row fv-plugins-icon-container">
									<!--begin::Label-->
									<label class="fs-5 fw-semibold mb-2">Answer1 (<?php echo $language ?>)</label>
									<!--end::Label-->
									<!--begin::Input-->
									<input type="text" class="form-control form-control-solid" placeholder="Enter Answer1" name="a1lang" value="<?php echo
									 $productResult[0]['answerlang'] ?>">
									 <input type="text" name="ans1id" value="<?php echo
									 $productResult[0]['ansid'] ?>" hidden>
									<!--end::Input-->
								</div>
								...
								<!--begin::Input group-->
									...
									<input type="text" class="form-control form-control-solid" placeholder="Enter Answer2 ( German )" name="a2_german" value="<?php echo
									 ...
									 $productResult[1]['ansid'] ?>" hidden>
										...
										<div class="col-lg-6">
											<div class="mb-5 fv-row fv-plugins-icon-container">
									<label class=" fs-5 fw-semibold mb-2">Answer2 (<?php echo $language ?>)</label>
									<input type="text" class="form-control form-control-solid" placeholder="Enter Answer2 " name="a2lang" value="<?php echo
									 $productResult[1]['answerlang'] ?>">
									 <input type="text" name="ans2id" value="<?php echo
									 $productResult[1]['ansid'] ?>" hidden>
								</div>
										</div>
								...
								<div class="col-lg-6">
											<div class="mb-5 fv-row fv-plugins-icon-container">
									<label class=" fs-5 fw-semibold mb-2">Answer3 (<?php echo $language ?>)</label>
									<input type="text" class="form-control form-control-solid" placeholder="Enter Answer3 " name="a3lang" value="<?php echo
									 $productResult[2]['answerlang'] ?>">
									 <input type="text" name="ans3id" value="<?php echo
									 $productResult[2]['ansid'] ?>" hidden>
								</div>
								</div>
								<div class="col-lg-6">
									...
									<input type="text" class="form-control form-control-solid" placeholder="Enter Answer4 ( German )" name="a4_german" value="<?php echo
									 $productResult[3]['ansgerman'] ?>">
									 <input type="text" name="ans4id" value="<?php echo
									 $productResult[3]['ansid'] ?>" hidden>
								</div>
								</div>
								...
								<div class="col-lg-6">
											<div class="mb-5 fv-row fv-plugins-icon-container">
									<label class=" fs-5 fw-semibold mb-2">Answer4 (<?php echo $language ?>)</label>
									<input type="text" class="form-control form-control-solid" placeholder="Enter Answer3 " name="a4lang" value="<?php echo
									 $productResult[3]['answerlang'] ?>">
									 <input type="text" name="ans4id" value="<?php echo
									 $productResult[3]['ansid'] ?>" hidden>
								</div>
								</div>
								    ...
								    <label class="form-check-label" for="">
										...
										<div class="col-lg-8 fv-row">
										<input type="text" class="form-control form-control-solid" placeholder="Enter Answer4 value" name="a4_value" value="<?php echo
									 $productResult[3]['answervalue'] ?>"> 
									</div> 
									<div class="col-lg-3 fv-row">
									<div class="form-check form-check-custom form-check-success form-check-solid">
								    <input class="form-check-input" type="checkbox" value="1" name="answer4"  <?php echo ($productResult[3]['answer']==1 ? 'checked' : '');?>/>
								    <label class="form-check-label" for="">
								        Right
								    </label>
									</div>
						...
						<fieldset class="setting-fieldset">
							...
							<div class="row">
   							...
   							<div class="mb-5 fv-row fv-plugins-icon-container">
									<!--begin::Label-->
									<label class=" fs-5 fw-semibold mb-2">Upload Audio German</label>
									<!--end::Label-->
									<!--begin::Input-->
									<input type="file" class="form-control form-control-solid"  name="audiofileg" accept="audio/*" value="<?php echo $rowquestion['audio_german'] ?>">
									<!--end::Input-->
									<label class=" fs-5 fw-semibold mb-2 mt-2"><audio controls autoplay muted> 
									  <source src="<?php echo 'uploads/german_audio/'.$rowquestion['audio_german'] ?>" type="audio/mp3">
									</audio>
									</label>
								</div>
   								</div>
   							...
   							<div class="mb-5 fv-row fv-plugins-icon-container">
									<!--begin::Label-->
									<label class=" fs-5 fw-semibold mb-2">Upload Audio <?php echo $language ?></label>
									<!--end::Label-->
									<!--begin::Input-->
									<input type="file" class="form-control form-control-solid"  name="audiofile" accept="audio/*" value="<?php echo $rowquestion['audio_'.$language] ?>">
									<!--end::Input-->
									<label class=" fs-5 fw-semibold mb-2 mt-2"><audio controls autoplay muted> 
									  <source src="<?php echo 'uploads/'.$language.'_audio/'.$rowquestion['audio_'.$language] ?>" type="audio/mp3">
									</audio>
									</label>
								</div>
   								</div>
   ...
   <div class="row">
   	...
   	<div class="col-lg-6">
   		<div class="mb-5 fv-row fv-plugins-icon-container">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input type="file" class="form-control form-control-solid" placeholder="Enter Question Name ( Urdu )" name="answervideo" accept="video/*" value="<?php echo $rowquestion['answervideo'] ?>">
									<!--end::Input-->
									<video width="120" height="150" autoplay>
									  <source src="uploads/<?php echo $rowquestion['answervideo'] ?>" type="video/mp4">
...
<button type="submit" id="kt_editquestion_submit" value="register" class="btn btn-primary">
...
<script type="text/javascript" src="questions/edit_question.js"></script>