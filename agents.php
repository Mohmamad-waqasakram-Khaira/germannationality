		...
		<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
			...
			<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
				...
				<li class="breadcrumb-item">
					...
					<!--end::Item-->
					<!--begin::Item-->
					<li class="breadcrumb-item text-muted">Manage Agents</li>
					<!--end::Item-->
			</ul>
			<!--end::Breadcrumb-->
		</div>
		...
		<div class="card card-flush">
			...
			<div class="card-header align-items-center py-5 gap-2 gap-md-5">
				...
				<div class="card-toolbar">
					<!--begin::Add customer-->
					<a href="javascript;" data-bs-toggle="modal" data-bs-target="#add_agent_modal" class="btn btn-primary"><i class="fas fa-plus" ></i> Add Agent</a>
					<!--end::Add customer-->
				</div>
				<!--end::Card toolbar-->
			</div>
				...
				<table id="kt_datatable_dom_positioning" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
					...
					<thead>
						...
						<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
							...
							<th class="min-w-150px">Referral Code</th>
					...
					<tbody class="fw-semibold text-gray-600">
						<!--begin::Table row-->
						 <?php $query=mysqli_query($con,"select * from agents");
                                $cnt=1;
						...
						<tr>
							...
							<td>
								<!--begin::Badges-->
								<!--begin::Thumbnail-->
									<a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name"><?php echo htmlentities($row['agent_id']);?></a>
									<!--end::Thumbnail-->
								<!--end::Badges-->
							</td>
							<!--end::Type=-->
							...
							<td class="text-end">
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
									...
									<!--begin::Menu item-->
									<div class="menu-item px-3">
										<a href="#" class="menu-link px-3"  onClick="u_details('<?php echo $row['agent_id']; ?>')"data-kt-ecommerce-category-filter="delete_row">Users</a>
									</div>
									<!--end::Menu item-->
									<div class="menu-item px-3">
...
<div class="modal fade modal-lg" tabindex="-1" id="udetailsModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Agent's Users Details</h3>
            ...
            <div class="modal-body" id="udetailsModal_body">
