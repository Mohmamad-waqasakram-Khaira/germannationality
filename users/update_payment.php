...
$u_id= $_POST['id'];
$status=$_POST['status'];
$queryupdate1 = mysqli_query($con,"UPDATE users set payment_status ='$status'  where id=$u_id");
...
<p>We have activated your account after payment confirmation.</p>
...
if($queryupdate1){?>
	...
	<script>toastr.success("Payment Status Updated Successfully!", "Success");</script>
<?php 
