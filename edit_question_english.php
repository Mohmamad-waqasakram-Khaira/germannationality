		...
		<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
			...
			<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
				...
				<li class="breadcrumb-item">
					...
					<!--end::Item-->
					<!--begin::Item-->
					<li class="breadcrumb-item text-muted">Edit Question English</li>
					<!--end::Item-->
			</ul>
			<!--end::Breadcrumb-->
		</div>
	...
	<!--begin::Category-->
		<div class="card card-flush">
			...
			<div class="card-body pt-0">
				<!--begin::Table-->
					<form id="update_question_english_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
						<!--begin::Modal body-->
							...
							<legend class="">Question Section</legend>
								...
								<!--begin::Input group-->
										...
										<div class="col-lg-6">
											<div class="mb-5 fv-row fv-plugins-icon-container">
									<!--begin::Label-->
									<label class=" fs-5 fw-semibold mb-2">Question (English)</label>
									<!--end::Label-->
									<!--begin::Input-->
									<input type="text" class="form-control form-control-solid" placeholder="Enter Question ( english )" name="q_english" value="<?php echo htmlentities($rowquestion['q_english']) ?>">
									<!--end::Input-->
								</div>
										</div>
						...
						<fieldset class="setting-fieldset">
							<legend class="">Answer Section</legend>
								...
								<!--begin::Input group-->
											...
											<div class="mb-5 fv-row fv-plugins-icon-container">
									<!--begin::Label-->
									<label class="fs-5 fw-semibold mb-2">Answer1 (English)</label>
									<!--end::Label-->
									<!--begin::Input-->
									<input type="text" class="form-control form-control-solid" placeholder="Enter Answer1 ( German )" name="a1_english" value="<?php echo
									 $productResult[0]['ansenglish'] ?>">
									 <input type="text" name="ans1id" value="<?php echo
									 $productResult[0]['ansid'] ?>" hidden>
									<!--end::Input-->
								</div>
								...
								<!--begin::Input group-->
									...
									<input type="text" class="form-control form-control-solid" placeholder="Enter Answer2 ( German )" name="a2_german" value="<?php echo
									 ...
									 $productResult[1]['ansid'] ?>" hidden>
										...
										<div class="col-lg-4">
											<div class="mb-5 fv-row fv-plugins-icon-container">
									<label class=" fs-5 fw-semibold mb-2">Answer2 (English)</label>
									<input type="text" class="form-control form-control-solid" placeholder="Enter Answer2 ( German )" name="a2_english" value="<?php echo
									 $productResult[1]['ansenglish'] ?>">
									 <input type="text" name="ans2id" value="<?php echo
									 $productResult[1]['ansid'] ?>" hidden>
								</div>
										</div>
								...
								<div class="col-lg-4">
											<div class="mb-5 fv-row fv-plugins-icon-container">
									<label class=" fs-5 fw-semibold mb-2">Answer3 (English)</label>
									<input type="text" class="form-control form-control-solid" placeholder="Enter Answer3 ( German )" name="a3_english" value="<?php echo
									 $productResult[2]['ansenglish'] ?>">
									 <input type="text" name="ans3id" value="<?php echo
									 $productResult[2]['ansid'] ?>" hidden>
								</div>
								</div>
   		...
   		<div class="mb-5 fv-row fv-plugins-icon-container">
									<!--begin::Label-->
									<label class=" fs-5 fw-semibold mb-2">Update Audio (English)</label>
									
									<input type="file" class="form-control form-control-solid"  name="audiofile" accept="audio/*" value="<?php echo $rowquestion['audio_english'] ?>"><?php echo $rowquestion['audio_english'] ?>
									<!--end::Input-->
								</div>
   	</div>
...
<button type="button" onclick="update_question_english()"  class="btn btn-primary">
