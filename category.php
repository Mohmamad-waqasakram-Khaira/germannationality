		...
		<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
			...
			<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
				...
				<li class="breadcrumb-item">
					...
					<!--end::Item-->
					<!--begin::Item-->
					<li class="breadcrumb-item text-muted">Manage Categories</li>
					<!--end::Item-->
			</ul>
			<!--end::Breadcrumb-->
		</div>
		...
		<div class="card card-flush">
			...
			<div class="card-header align-items-center py-5 gap-2 gap-md-5">
				...
				<div class="card-toolbar">
					<!--begin::Add customer-->
					<a href="javascript;" data-bs-toggle="modal" data-bs-target="#add_category_modal" class="btn btn-primary"><i class="fas fa-plus" ></i> Add Category</a>
					<!--end::Add customer-->
				</div>
				<!--end::Card toolbar-->
			</div>
...
<div class="modal fade" id="add_category_modal" tabindex="-1">
			...
			<div class="modal-dialog modal-dialog-centered mw-650px">
				...
				<div class="modal-content">
					...
					<!--end::Modal header-->
					<!--begin::Form-->
					<form id="create_category_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
						<!--begin::Modal body-->
						<div class="modal-body py-10 px-lg-17">
							...
							<div class="scroll-y me-n7 pe-7" id="kt_modal_create_api_key_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_create_api_key_header" data-kt-scroll-wrappers="#kt_modal_create_api_key_scroll" data-kt-scroll-offset="300px" style="max-height: 41px;">
								...
								<div class="mb-5 fv-row fv-plugins-icon-container">
									<!--begin::Label-->
									<label class="required fs-5 fw-semibold mb-2">Category Name (German)</label>
									<!--end::Label-->
									<!--begin::Input-->
									<input type="text" class="form-control form-control-solid" placeholder="Enter Category Name ( German )" name="c_name_german">
									<!--end::Input-->
								...
								<div class="mb-5 fv-row fv-plugins-icon-container">
									<!--begin::Label-->
									<label class="required fs-5 fw-semibold mb-2">Category Name (Urdu)</label>
									<!--end::Label-->
									<!--begin::Input-->
									<input type="text" class="form-control form-control-solid" placeholder="Enter Category Name ( Urdu )" name="c_name_urdu">
									<!--end::Input-->
								<div class="fv-plugins-message-container invalid-feedback"></div></div>
								<!--end::Input group-->
								<div class="mb-5 fv-row fv-plugins-icon-container">
									<!--begin::Label-->
									<label class="required fs-5 fw-semibold mb-2">Category Name (Pashto)</label>
									<!--end::Label-->
									<!--begin::Input-->
									<input type="text" class="form-control form-control-solid" placeholder="Enter Category Name ( Pashto )" name="c_name_pashto">
									<!--end::Input-->
								<div class="fv-plugins-message-container invalid-feedback"></div></div>
								<!--begin::Input group-->
    <div class="fv-row mb-7">
        <!--begin::Label-->
        <label class="d-block fw-semibold fs-6 mb-5">Upload Category Image</label>
        <!--end::Label-->
        ...
        <div class="image-input image-input-outline image-input-empty" data-kt-image-input="true" style="background-image: url('assets/media/svg/avatars/blank.svg')">
            ...
            <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change avatar">
                ...
                <!--begin::Inputs-->
                <input type="file" name="c_image" id="file"  />
    ...
    <!--end::Input group-->
						...
						<div class="modal-footer flex-center">
							...
							<!--end::Button-->
							<!--begin::Button-->
							<button type="submit" id="create_category_form_submit" class="btn btn-primary">
